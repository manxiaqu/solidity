...
contract StaticStorage {
        ...
        function at(address _addr) public view returns (bytes memory o_code, bytes32 len) {
                assembly {
        ...
        function helloWorld() public pure returns (string memory word) {
                assembly {
                        ...
                        mstore(add(word, 0x20), 0x68656c6c6f20776f726c64000000000000000000000000000000000000000000)
                }
        }
